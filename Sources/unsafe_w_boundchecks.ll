...
@llvm.used = appending global [10 x ptr] [ptr @"\01l_entry_point", ptr @"$s17UnsafeBufferTests21unsafebufferpointert1ySiSRySiGF", ptr @"$s17UnsafeBufferTests21unsafebufferpointert2ySiSRySiG_SitF", ptr @"$s17UnsafeBufferTests21unsafebufferpointert3ySiSRySiGF", ptr @"$s17UnsafeBufferTests21unsafebufferpointert4ySbSRySiG_SitF", ptr @"$s17UnsafeBufferTests21unsafebufferpointert5ySiSRySiG_SitF", ptr @"$s17UnsafeBufferTests22unsafebufferpointert2bySiSRySiG_SitF", ptr @"$s17UnsafeBufferTests22unsafebufferpointert2cySiSRySiG_SitF", ptr @__swift_reflection_version, ptr @main], section "llvm.metadata"
...
define swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert1ySiSRySiGF"(i64 %0, i64 %1) #1 {
entry:
  %2 = icmp eq i64 %0, 0
...
define swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert2ySiSRySiG_SitF"(i64 %0, i64 %1, i64 %2) #3 {
  %4 = tail call swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert2ySiSRySiG_SitFTm"(i64 %0, i64 %1, i64 %2) #3
  ret i64 %4
}
...
define swiftcc i64 @"$s17UnsafeBufferTests22unsafebufferpointert2bySiSRySiG_SitF"(i64 %0, i64 %1, i64 %2) #3 {
  %4 = tail call swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert2ySiSRySiG_SitFTm"(i64 %0, i64 %1, i64 %2) #3
  ret i64 %4
}

define internal swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert2ySiSRySiG_SitFTm"(i64 %0, i64 %1, i64 %2) #3 {
entry:
  %3 = icmp slt i64 %2, 0
...
define swiftcc i64 @"$s17UnsafeBufferTests22unsafebufferpointert2cySiSRySiG_SitF"(i64 %0, i64 %1, i64 %2) #3 {
entry:
  %3 = icmp slt i64 %1, %2
...
define swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert3ySiSRySiGF"(i64 %0, i64 %1) #3 {
entry:
  %2 = icmp eq i64 %1, 0
  br i1 %2, label %.loopexit, label %3
...
define swiftcc i1 @"$s17UnsafeBufferTests21unsafebufferpointert4ySbSRySiG_SitF"(i64 %0, i64 %1, i64 %2) #3 {
entry:
  %3 = icmp slt i64 %2, 0
...
define swiftcc i64 @"$s17UnsafeBufferTests21unsafebufferpointert5ySiSRySiG_SitF"(i64 %0, i64 %1, i64 %2) #3 {
entry:
  %3 = icmp slt i64 %2, 0
  br i1 %3, label %4, label %5, !prof !19
